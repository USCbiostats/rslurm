...
.rslurm_func   <- readRDS('/home/vegayon/Documents/rslurm/vignettes/_rslurm_test_apply/f.RDS')
.rslurm_params <- readRDS('/home/vegayon/Documents/rslurm/vignettes/_rslurm_test_apply/params.RDS')
...
saveRDS(.rslurm_result, file = paste0('/home/vegayon/Documents/rslurm/vignettes/_rslurm_test_apply/results_', .rslurm_id, '.RDS'))
